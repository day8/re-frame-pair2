...
- [re-frame-pair-improver2](https://github.com/day8/re-frame-pair-improver2) — *(planned)* the post-session retrospective skill that reviews pair sessions and proposes improvements to re-frame-pair2 itself. Sibling to v1's [re-frame-pair-improver](https://github.com/day8/re-frame-pair-improver).
